...
import it.polimi.ingsw.client.communication.RMIClientConnection;
...
public class CLIView extends View{
    ...
    public void showJoinResponse(JoinResponse joinResponse) {
        this.lastShowed = "join Response was: " + joinResponse;
    }
    public CLIView(ClientCommunication clientCommunication) {
